...
class MockDatabase {
  ...
  resetToSeed() {
    this.agencies = [
      { id: 'a0000001-0000-0000-0000-000000000001', category: 'NDRF', name: 'NDRF 8th Battalion Uttarakhand', incident_commander: 'Col. Rakesh Sharma', radio_channel: 'CH-01', phone: '+91-135-2700001' },
      { id: 'a0000001-0000-0000-0000-000000000002', category: 'SDRF', name: 'SDRF Uttarakhand Alpine Rescue', incident_commander: 'Maj. Priya Singh', radio_channel: 'CH-02', phone: '+91-135-2700002' },
      { id: 'a0000001-0000-0000-0000-000000000003', category: 'Local_Police', name: 'Uttarakhand Police Garhwal Division', incident_commander: 'DCP Anil Gupta', radio_channel: 'CH-03', phone: '+91-135-2700003' },
      { id: 'a0000001-0000-0000-0000-000000000004', category: 'Health_Dept', name: 'Srinagar Base Hospital Trauma DART', incident_commander: 'Dr. Meena Sharma', radio_channel: 'CH-04', phone: '+91-135-2700004' },
      { id: 'a0000001-0000-0000-0000-000000000005', category: 'NGO_Volunteer', name: 'ITBP & Himalayan Mountain Guides Syndicate', incident_commander: 'Subedar Tenzing Norbu', radio_channel: 'CH-05' },
    ];

    this.assets = [
      { id: 'b0000001-0000-0000-0000-000000000001', agency_id: 'a0000001-0000-0000-0000-000000000001', name: 'NDRF Motorized Zodiac Boat Alpha-1', call_sign: 'NDRF-MB1', category: 'Motorized_Rescue_Boat', capability_tags: ['water_rescue', 'evac', 'floodwater_capable'], capabilities: { evac_capacity_persons: 8, speed_kmh: 30, max_range_km: 35, floodwater_capable: true }, fuel_level: 0.92, status: 'Available', latitude: 30.2854, longitude: 78.9812, last_telemetry_at: new Date().toISOString(), is_deleted: false, updated_at: new Date().toISOString(), updated_by: 'SEED' },
      { id: 'b0000001-0000-0000-0000-000000000002', agency_id: 'a0000001-0000-0000-0000-000000000001', name: 'NDRF Rapid Raft Alpha-2', call_sign: 'NDRF-MB2', category: 'Motorized_Rescue_Boat', capability_tags: ['water_rescue', 'evac', 'floodwater_capable'], capabilities: { evac_capacity_persons: 8, speed_kmh: 30, max_range_km: 35, floodwater_capable: true }, fuel_level: 0.78, status: 'Available', latitude: 30.2227, longitude: 78.7844, last_telemetry_at: new Date().toISOString(), is_deleted: false, updated_at: new Date().toISOString(), updated_by: 'SEED' },
      { id: 'b0000001-0000-0000-0000-000000000003', agency_id: 'a0000001-0000-0000-0000-000000000002', name: 'SDRF High-Altitude Rescue Squad Echo-1', call_sign: 'SDRF-K1', category: 'K9_Search_Squad', capability_tags: ['search_rescue', 'structural', 'road_capable'], capabilities: { evac_capacity_persons: 0, speed_kmh: 40, max_range_km: 50, k9: true }, fuel_level: 1.0, status: 'Available', latitude: 30.5564, longitude: 79.5668, last_telemetry_at: new Date().toISOString(), is_deleted: false, updated_at: new Date().toISOString(), updated_by: 'SEED' },
      { id: 'b0000001-0000-0000-0000-000000000004', agency_id: 'a0000001-0000-0000-0000-000000000002', name: 'SDRF 4x4 Mountain Ambulance Delta-1', call_sign: 'SDRF-A1', category: '4x4_Ambulance', capability_tags: ['medical_als', 'medical_bls', 'evac', 'road_capable'], capabilities: { evac_capacity_persons: 3, speed_kmh: 60, max_range_km: 80, medical_als: true, medical_bls: true }, fuel_level: 0.90, status: 'Available', latitude: 30.2588, longitude: 79.2185, last_telemetry_at: new Date().toISOString(), is_deleted: false, updated_at: new Date().toISOString(), updated_by: 'SEED' },
      { id: 'b0000001-0000-0000-0000-000000000005', agency_id: 'a0000001-0000-0000-0000-000000000003', name: 'Garhwal Police FLIR Thermal Drone Foxtrot-1', call_sign: 'JCP-D1', category: 'Surveillance_Drone', capability_tags: ['recon', 'thermal_camera'], capabilities: { evac_capacity_persons: 0, speed_kmh: 80, max_range_km: 15, thermal_camera: true }, fuel_level: 0.95, status: 'Available', latitude: 30.5278, longitude: 79.5220, last_telemetry_at: new Date().toISOString(), is_deleted: false, updated_at: new Date().toISOString(), updated_by: 'SEED' },
      { id: 'b0000001-0000-0000-0000-000000000006', agency_id: 'a0000001-0000-0000-0000-000000000004', name: 'AIIMS Mobile Trauma Team Golf-1', call_sign: 'SMS-MT1', category: 'Medical_Team', capability_tags: ['medical_als', 'medical_bls', 'triage', 'road_capable'], capabilities: { evac_capacity_persons: 2, speed_kmh: 50, max_range_km: 30, medical_als: true, medical_bls: true, triage: true }, fuel_level: 1.0, status: 'Available', latitude: 30.2227, longitude: 78.7844, last_telemetry_at: new Date().toISOString(), is_deleted: false, updated_at: new Date().toISOString(), updated_by: 'SEED' },
      { id: 'b0000001-0000-0000-0000-000000000007', agency_id: 'a0000001-0000-0000-0000-000000000005', name: 'ITBP 1st Mountain Battalion Hotel-1', call_sign: 'VOL-B1', category: 'Other', category_detail: 'Indo-Tibetan Border Police alpine rescue column', capability_tags: ['water_rescue', 'evac', 'shallow_water'], capabilities: { evac_capacity_persons: 12, speed_kmh: 25, max_range_km: 40, floodwater_capable: true }, fuel_level: 1.0, status: 'Available', latitude: 30.5564, longitude: 79.5668, last_telemetry_at: new Date().toISOString(), is_deleted: false, updated_at: new Date().toISOString(), updated_by: 'SEED' },
    ];

    this.incidents = [
      { id: 'c0000001-0000-0000-0000-000000000001', raw_sos_text: 'Alaknanda water 4.2m above danger level; riverside ghats submerged at Rudraprayag Sangam. 64 pilgrims trapped on temple terrace.', origin_channel: 'WEB_SOS', primary_need: 'Water_Evacuation', secondary_needs: [], required_capability_tags: ['water_rescue', 'evac'], ai_triage_tier: 'T1_Immediate', priority_score: 0.94, ai_confidence: 0.95, ai_rationale: 'T1_Immediate: 64 trapped in raging river confluence with zero foot access.', people_count: 64, vulnerable_infants: 4, vulnerable_elderly: 18, vulnerable_critical_ill: 2, latitude: 30.2854, longitude: 78.9812, h3_res7: '87609a654ffffff', h3_res9: '88609a6567fffff', status: 'Open', client_recorded_at: new Date().toISOString(), created_at: new Date(Date.now() - 600000).toISOString(), updated_at: new Date().toISOString(), updated_by: 'SYSTEM' },
      { id: 'c0000001-0000-0000-0000-000000000002', raw_sos_text: 'Dam spillway surge inundating low-lying residential sectors at Srinagar Garhwal Riverside. 45 residents trapped.', origin_channel: 'FIELD_APP', primary_need: 'Water_Evacuation', secondary_needs: [], required_capability_tags: ['water_rescue', 'evac'], ai_triage_tier: 'T1_Immediate', priority_score: 0.81, ai_confidence: 0.92, ai_rationale: 'T1_Immediate: Spillway breach inundating Srinagar houses.', people_count: 45, vulnerable_infants: 2, vulnerable_elderly: 12, vulnerable_critical_ill: 1, latitude: 30.2227, longitude: 78.7844, h3_res7: '87609a650ffffff', h3_res9: '88609a6561fffff', status: 'Open', client_recorded_at: new Date().toISOString(), created_at: new Date(Date.now() - 500000).toISOString(), updated_at: new Date().toISOString(), updated_by: 'SYSTEM' },
      { id: 'c0000001-0000-0000-0000-000000000003', raw_sos_text: 'Glacial debris landslide with structural bridge damage at Joshimath Raini Sector. 32 people trapped under rockfall.', origin_channel: 'COMMANDER_ENTRY', primary_need: 'Structural_Extrication', secondary_needs: [], required_capability_tags: ['search_rescue', 'structural'], ai_triage_tier: 'T1_Immediate', priority_score: 0.89, ai_confidence: 0.90, ai_rationale: 'T1_Immediate: Heavy debris trapping villagers in Raini valley.', people_count: 32, vulnerable_infants: 1, vulnerable_elderly: 6, vulnerable_critical_ill: 4, latitude: 30.5564, longitude: 79.5668, h3_res7: '87609a652ffffff', h3_res9: '88609a6555fffff', status: 'Open', client_recorded_at: new Date().toISOString(), created_at: new Date(Date.now() - 400000).toISOString(), updated_at: new Date().toISOString(), updated_by: 'SYSTEM' },
      { id: 'c0000001-0000-0000-0000-000000000004', raw_sos_text: 'NH-07 Badrinath Highway washed out at Helang Bridge Km 18. 85 bus pilgrims cut off with injuries.', origin_channel: 'FIELD_APP', primary_need: 'Medical_Emergency', secondary_needs: [], required_capability_tags: ['medical_als', 'evac'], ai_triage_tier: 'T1_Immediate', priority_score: 0.91, ai_confidence: 0.94, ai_rationale: 'T1_Immediate: Mountain highway washed out, multiple fractures and trauma.', people_count: 85, vulnerable_infants: 5, vulnerable_elderly: 24, vulnerable_critical_ill: 8, latitude: 30.5278, longitude: 79.5220, h3_res7: '87609a655ffffff', h3_res9: '88609a6549fffff', status: 'Open', client_recorded_at: new Date().toISOString(), created_at: new Date(Date.now() - 300000).toISOString(), updated_at: new Date().toISOString(), updated_by: 'SYSTEM' },
      { id: 'c0000001-0000-0000-0000-000000000005', raw_sos_text: 'Mandakini tributary overflowing, road to Kedarnath base blocked at Guptkashi. Low communications, silent pocket.', origin_channel: 'WEB_SOS', primary_need: 'Water_Evacuation', secondary_needs: [], required_capability_tags: ['water_rescue', 'evac'], ai_triage_tier: 'T2_Delayed', priority_score: 0.72, ai_confidence: 0.55, ai_rationale: 'T2_Delayed: Flash flood tributary surge with road cut.', people_count: 28, vulnerable_infants: 2, vulnerable_elderly: 4, vulnerable_critical_ill: 0, latitude: 30.5229, longitude: 79.0768, h3_res7: '87609a656ffffff', h3_res9: '88609a6544fffff', status: 'Open', client_recorded_at: new Date().toISOString(), created_at: new Date(Date.now() - 200000).toISOString(), updated_at: new Date().toISOString(), updated_by: 'SYSTEM' },
    ];
